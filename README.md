...
```bash
cd care
git clone git@github.com:ohcnetwork/Care Communication.git
```
...
To install care Care Communication, you can add the plugin config in [care/plug_config.py](https://github.com/ohcnetwork/care/blob/develop/plug_config.py) as follows:

```python
...

Care Communication_plug = Plug(
    name=Care Communication,
    package_name="git+https://github.com/ohcnetwork/Care Communication.git",
    version="@master",
    configs={},
)
plugs = [Care Communication_plug]
...
```
